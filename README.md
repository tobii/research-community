...
| [Titta LSL Streamer](https://github.com/dcnieho/Titta/tree/master/LSL_streamer) | 🔀 Multimodal experiments | Enables multi-participant experiments via LSL with low latency.               |
...
| [PupEyes](https://github.com/HanZhang-psych/pupeyes)                                        | 🔀 Pupillometry preprocessing | Interactive preprocessing and visualization of pupil data.                 |
...
| [Titta LSL Streamer](https://github.com/dcnieho/Titta/tree/master/LSL_streamer) | 🔀 Multimodal integration   | Extends Titta for synchronized multi-device and multi-participant experiments over LSL.                                         |
...
| [TP3Py](https://github.com/SUNYOpt/TP3Py)                                | 👓 Streaming       | Real-time pipeline for wearable gaze and head tracking. |
...
| [EyeLiveMetrics](https://git.gesis.org/iir/eyelivemetrics) | 🖥️ Real-time analysis | Browser-based tool for real-time gaze and reading metrics.      |
